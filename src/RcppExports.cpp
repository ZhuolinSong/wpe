...
RcppExport SEXP _wpe_RgradQ(SEXP LtSEXP, SEXP LrSEXP, SEXP LSEXP, SEXP BSEXP, SEXP USEXP, SEXP VSEXP, SEXP WSEXP, SEXP lamSEXP, SEXP weightSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _wpe_RhessianQ(SEXP LtSEXP, SEXP LrSEXP, SEXP SSEXP, SEXP BSEXP, SEXP USEXP, SEXP VSEXP, SEXP WSEXP, SEXP lamSEXP, SEXP weightSEXP, SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type Lt(LtSEXP);
...
RcppExport SEXP _wpe_crawcov(SEXP LtSEXP, SEXP LySEXP, SEXP weigSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type Lt(LtSEXP);
...
RcppExport SEXP _wpe_csmoothcov(SEXP hSEXP, SEXP kernelSEXP, SEXP xySEXP, SEXP zSEXP, SEXP wSEXP, SEXP xgridSEXP, SEXP ygridSEXP, SEXP deltaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _wpe_csmoothmean(SEXP xSEXP, SEXP zSEXP, SEXP wSEXP, SEXP hSEXP, SEXP kernelSEXP, SEXP dSEXP, SEXP newxSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_wpe_RgradQ", (DL_FUNC) &_wpe_RgradQ, 9},
    {"_wpe_RhessianQ", (DL_FUNC) &_wpe_RhessianQ, 10},
    {"_wpe_crawcov", (DL_FUNC) &_wpe_crawcov, 3},
    {"_wpe_csmoothcov", (DL_FUNC) &_wpe_csmoothcov, 8},
    {"_wpe_csmoothmean", (DL_FUNC) &_wpe_csmoothmean, 7},
    {NULL, NULL, 0}
};

RcppExport void R_init_wpe(DllInfo *dll) {
